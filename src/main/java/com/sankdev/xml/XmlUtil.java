...
/**
 * Utility interface for working with xml files using JAXB marshalling (jaxb-ri).
 * Marshalling and unmarshalling methods should use the same JAXB context
 * @param <T> - the class mapped to the root xml element. Usually it is a class
 *           generated with JAXB xjc binding compiler. <b>The mapped class must have
 *           {@link jakarta.xml.bind.annotation.XmlRootElement} annotation.</b>
 */
public interface XmlUtil<T> {
     ...
     * @param rootElementValue the object  representing the root element
     *                    to marshal to a file. It must have
